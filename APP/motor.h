...
#define M1_STOP         {GPIO_RsetBits(GPIOE, GPIO_Pin_2); GPIO_ResetBits(GPIOE, GPIO_Pin_3);}
...
#define M2_STOP         {GPIO_ResetBits(GPIOE, GPIO_Pin_4); GPIO_ResetBits(GPIOE, GPIO_Pin_5);}
